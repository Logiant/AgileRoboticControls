  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2756296038U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(685491994U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3461781139U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1265263414U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3158756183U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3276675224U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(151471265U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3857505216U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "FAcsI1ZiaGTdldY8UllSPB") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "Ousqk5sLkmNdk8cllLjw3G") == 0) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "BXzTTtjQZZoiXDMcv050CC") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "O8D3KYM0naGWtfs4WmGUwD") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "BPELkoA4nucaGHYwodt1gF") == 0) {
     ...
     case 4:
      {
        if (strcmp(tpChksum, "iDthKt0j8vEbhzTEWP1QFF") == 0) {
