...
static const char * c1_debug_family_names[5] = { "Array", "nargin", "nargout",
  "index", "x" };
  ...
  (SFc1_SingleCylinderTestInstanceStruct *chartInstance)
{
  ...
  real_T c1_x;
  int32_T c1_i0;
  static real_T c1_dv0[10] = { 1.0, 1.25, 1.5, 1.75, 2.0, 2.0, 1.75, 1.5, 1.25,
    1.0 };

  real_T *c1_b_x;
  int32_T *c1_b_index;
  c1_b_index = (int32_T *)ssGetInputPortSignal(chartInstance->S, 0);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_Array, 0U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 2U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_index, 3U, c1_b_sf_marshallOut);
  ...
  c1_x = c1_Array[_SFD_EML_ARRAY_BOUNDS_CHECK("Array", (int32_T)
    _SFD_INTEGER_CHECK("index", (real_T)c1_index), 1, 10, 1, 0) - 1];
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -5);
  ...
  *c1_b_x = c1_x;
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c1_b_index, 1U);
}
  ...
  *c1_inData)
{
  ...
  for (c1_i1 = 0; c1_i1 < 10; c1_i1++) {
    c1_b_inData[c1_i1] = (*(real_T (*)[10])c1_inData)[c1_i1];
  }
  ...
  real_T c1_y[10])
{
  ...
  int32_T c1_i3;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv1, 1, 0, 0U, 1, 0U, 2, 1, 10);
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i4 = 0; c1_i4 < 10; c1_i4++) {
    (*(real_T (*)[10])c1_outData)[c1_i4] = c1_y[c1_i4];
  }
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isfinite"), "name", "name", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("floor"), "name", "name", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 11);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("realmax"), "name", "name", 11);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!float_colon_length"),
                  "context", "context", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eps"), "name", "name", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_eps"), "name", "name", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!maxabs"), "context",
                  "context", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("abs"), "name", "name", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(924867550U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1284920882U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3472930475U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3633134782U);
}
...
mxArray *sf_c1_SingleCylinderTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("FAcsI1ZiaGTdldY8UllSPB");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T *c1_x;
          int32_T *c1_index;
          c1_index = (int32_T *)ssGetInputPortSignal(chartInstance->S, 0);
          c1_x = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
...
static void mdlSetWorkWidths_c1_SingleCylinderTest(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2261733078U));
  ssSetChecksum1(S,(600536600U));
  ssSetChecksum2(S,(703695988U));
  ssSetChecksum3(S,(4289494729U));
