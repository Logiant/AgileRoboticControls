...
static const char * c1_debug_family_names[7] = { "indexTemp", "Array", "nargin",
  "nargout", "index", "x1", "x2" };
...
static real_T c1_emlrt_marshallIn(SFc1_SimulationInstanceStruct *chartInstance,
  const mxArray *c1_x2, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_SimulationInstanceStruct *chartInstance,
  ...
  chartInstance)
{
  ...
  real_T *c1_x1;
  real_T *c1_x2;
  c1_x2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_x1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellmatrix(3, 1), false);
  c1_hoistedGlobal = *c1_x1;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = *c1_x2;
  c1_b_u = c1_b_hoistedGlobal;
  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", &c1_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 1, c1_c_y);
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_Simulation;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_x1 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "x1");
  *c1_x2 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "x2");
  ...
  *chartInstance)
{
  ...
  real_T *c1_b_index;
  real_T *c1_b_x2;
  c1_b_x2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_b_index = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c1_b_x1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_x1, 5U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_x2, 6U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 0, c1_index < 1.0)) {
    ...
    if (CV_EML_IF(0, 1, 1, c1_index > 10.0)) {
  ...
  c1_x1 = c1_Array[_SFD_EML_ARRAY_BOUNDS_CHECK("Array", (int32_T)
    _SFD_INTEGER_CHECK("indexTemp", c1_indexTemp), 1, 10, 1, 0) - 1];
  ...
  *c1_b_x2 = c1_x2;
  ...
  _SFD_DATA_RANGE_CHECK(*c1_b_x1, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_b_index, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_b_x2, 2U);
}
  ...
  const mxArray *c1_x2, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_x2), &c1_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1967275906U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4119791438U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1380442324U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2229379029U);
}
...
mxArray *sf_c1_Simulation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("278jY4S89uzrNAWeoi6kED");
...
static const mxArray *sf_get_sim_state_info_c1_Simulation(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[6],T\"x1\",},{M[1],M[7],T\"x2\",},{M[8],M[0],T\"is_active_c1_Simulation\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"x1");
          _SFD_SET_DATA_PROPS(1,1,1,0,"index");
          _SFD_SET_DATA_PROPS(2,2,0,1,"x2");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,69,82,102,120);
        _SFD_CV_INIT_EML_IF(0,1,1,102,120,-1,120);
...

        {
          ...
          c1_x1 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_x1);
  ...
  st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Simulation();/* state var info */
...
static void mdlSetWorkWidths_c1_Simulation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4088572048U));
  ssSetChecksum1(S,(1750390569U));
  ssSetChecksum2(S,(4237231030U));
  ssSetChecksum3(S,(1881166088U));
