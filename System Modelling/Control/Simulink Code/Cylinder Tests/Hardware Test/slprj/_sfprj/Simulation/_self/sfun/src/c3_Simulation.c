...
static void c3_set_sim_state_side_effects_c3_Simulation
...
static void sf_gateway_c3_Simulation(SFc3_SimulationInstanceStruct
  *chartInstance);
...
static real_T c3_emlrt_marshallIn(SFc3_SimulationInstanceStruct *chartInstance,
  const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SimulationInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_c_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_b_tp_Idle, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_h_emlrt_marshallIn(SFc3_SimulationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_SimulationInstanceStruct
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_c3_Simulation = c3_IN_NO_ACTIVE_CHILD;
}
  ...
  chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_c3_Simulation;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_index_out = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 0)), "index_out");
  chartInstance->c3_is_active_c3_Simulation = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_Simulation");
  chartInstance->c3_is_c3_Simulation = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_c3_Simulation");
  ...
  *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_Simulation(chartInstance);
  ...
  if (chartInstance->c3_is_active_c3_Simulation == 0U) {
    ...
    *c3_index_out = *c3_index_in;
    ...
    switch (chartInstance->c3_is_c3_Simulation) {
     case c3_IN_Forward:
      CV_CHART_EVAL(1, 0, 1);
     ...
     case c3_IN_Idle:
      ...
      if (c3_b_out) {
        ...
        chartInstance->c3_tp_Idle = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_Simulation = c3_IN_Forward;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_Forward = 1U;
        ...
        *c3_index_out = *c3_index_in + 1.0;
        ...
        if (c3_c_out) {
          ...
          chartInstance->c3_tp_Idle = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_Simulation = c3_IN_Reverse;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
          chartInstance->c3_tp_Reverse = 1U;
...
static const mxArray *sf_get_sim_state_info_c3_Simulation(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[16],T\"index_out\",},{M[8],M[0],T\"is_active_c3_Simulation\",},{M[9],M[0],T\"is_c3_Simulation\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SimulationInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c3_Simulation((SFc3_SimulationInstanceStruct*) chartInstanceVar);
}
  ...
  st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_Simulation();/* state var info */
