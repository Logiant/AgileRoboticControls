...
static real_T c4_emlrt_marshallIn(SFc4_SimulationInstanceStruct *chartInstance,
  const mxArray *c4_index_out, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_SimulationInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_SimulationInstanceStruct
  ...
  chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_Simulation;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_index_out = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 0)), "index_out");
  chartInstance->c4_is_active_c4_Simulation = c4_d_emlrt_marshallIn
...
static const mxArray *sf_get_sim_state_info_c4_Simulation(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"index_out\",},{M[8],M[0],T\"is_active_c4_Simulation\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_SimulationInstanceStruct *) chartInfo->chartInstance;
  ...
  st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_Simulation();/* state var info */
