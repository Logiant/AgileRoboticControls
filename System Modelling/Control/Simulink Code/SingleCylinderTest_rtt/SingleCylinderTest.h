...
typedef struct {
  ...
  uint8_T is_active_c3_SingleCylinderTest;/* '<S5>/Chart' */
  uint8_T is_c3_SingleCylinderTest;    /* '<S5>/Chart' */
 ...
 * '<S1>'   : 'SingleCylinderTest/High Level System Controller'
 * '<S2>'   : 'SingleCylinderTest/Long Cylinder PID'
 * '<S3>'   : 'SingleCylinderTest/Short Cylinder PID'
 * '<S4>'   : 'SingleCylinderTest/High Level System Controller/System Model'
 * '<S5>'   : 'SingleCylinderTest/High Level System Controller/System Model/State Machine'
 * '<S6>'   : 'SingleCylinderTest/High Level System Controller/System Model/Threshold'
 * '<S7>'   : 'SingleCylinderTest/High Level System Controller/System Model/State Machine/Calculate Foot Position'
 * '<S8>'   : 'SingleCylinderTest/High Level System Controller/System Model/State Machine/Chart'
 * '<S9>'   : 'SingleCylinderTest/High Level System Controller/System Model/State Machine/MATLAB Function'
 * '<S10>'  : 'SingleCylinderTest/High Level System Controller/System Model/State Machine/Calculate Foot Position/MATLAB Function'
 * '<S11>'  : 'SingleCylinderTest/Long Cylinder PID/Extend Command'
 * '<S12>'  : 'SingleCylinderTest/Long Cylinder PID/Retract Command'
 * '<S13>'  : 'SingleCylinderTest/Long Cylinder PID/Split Signal'
 * '<S14>'  : 'SingleCylinderTest/Short Cylinder PID/Extend Command'
 * '<S15>'  : 'SingleCylinderTest/Short Cylinder PID/Retract Command'
 * '<S16>'  : 'SingleCylinderTest/Short Cylinder PID/Split Signal'
 */
