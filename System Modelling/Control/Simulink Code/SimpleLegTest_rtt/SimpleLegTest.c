 ...
 * C/C++ source code generated on : Wed May 20 21:36:52 2015
 *
...
void SimpleLegTest_output(void)
{
   ...
   *  Sum: '<Root>/Sum'
   */
  rtb_Abs1 = (SimpleLegTest_B.Switch - SimpleLegTest_P.Constant1_Value_n) *
    SimpleLegTest_P.Constant2_Value_i;
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      rtb_DataTypeConversion_h = (uint8_T)SimpleLegTest_B.Switch;
    } else {
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[1] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[1] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[2] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[2] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[3] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[3] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[4] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[4] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[5] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[5] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[6] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[6] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[7] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[7] = 0U;
    }
  ...
  if (SimpleLegTest_B.Switch < 256.0) {
    if (SimpleLegTest_B.Switch >= 0.0) {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[8] = (uint8_T)SimpleLegTest_B.Switch;
    } else {
      /* S-Function (arduinoserialwrite_sfcn): '<S4>/Serial Transmit' */
      tmp[8] = 0U;
    }
